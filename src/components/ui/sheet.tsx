...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), className, "!py-4")}
      {...props}
    >
      <SheetPrimitive.Close className="absolute top-8 right-4 disabled:pointer-events-none">
        <X className="text-accent !h-8 !w-8" />
