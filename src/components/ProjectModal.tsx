...
export const ProjectModal = (props: {
  ...
  return (
    <div
      className="z-50 fixed bg-black/75 h-screen w-screen flex items-center justify-center top-0 left-0 right-0 bottom-0"
      role="dialog"
      aria-modal="true"
    >
      <div
        className="bg-indigo-900 relative flex flex-col gap-4 items-center rounded-lg min-h-fit max-h-[95%] p-4 overflow-y-auto"
        style={{
